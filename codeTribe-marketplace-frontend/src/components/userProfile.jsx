...
import { updateUser, toggleEditing } from "../../src/features/userSlice"; // Import the correct actions
...
function AdminProfile() {
  ...
  useEffect(() => {
    ...
    const fetchUserData = async () => {
      ...
      if (storedUser) {
        dispatch(updateUser(storedUser)); // Dispatch updateUser action
      }
    };
  ...
  const handleUserChange = (e) => {
    ...
    dispatch(updateUser(updatedUser)); // Dispatch updateUser action
